...
/*   Updated: 2016/12/26 12:42:53 by elcarrei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*---------------------------------------------------------------LIBFT/-------------------------------------------------------------*/
/*---------------------------------------------------------------FILLIT-------------------------------------------------------------*/
f_list				*ft_tabtolst(char **map);
f_list				*ft_create_elem(f_list *lst, char **piece, int c);
f_list				*ft_create_lst(char **piece);
int					ft_piece_len(char **piece);
int					ft_piece_high(char **piece);
char				**ft_save(f_list *piece, char **dst);
char				**ft_fillit(f_list *lst, char **dst);
/*---------------------------------------------------------------FILLIT/------------------------------------------------------------*/
